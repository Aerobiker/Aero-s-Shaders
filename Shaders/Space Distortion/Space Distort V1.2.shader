Shader "AeroFunky/Space Distort V1.2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				float xsquared = dot(objectUV, objectUV)*distanceOrigin*_DistortionScale;
